...
if __name__ == "__main__":
    ...
    cur_dirname = os.path.abspath(os.path.dirname(__file__))
    data_dirname = os.path.join(cur_dirname,'visual',"results")
    default=data_dirname+"/cbow.png"
    # plotting
    show_w2v_word_embedding(m, d, default)